...
<hr>เป็นอย่างคิดที่เมื่อแสดงข้อความเสร็จโปรแกรมก็จะบอกให้กดสักkeyพอกดแล้วก็จะปิดหน้านั้นไปเพราะรับkeyไม่มีทำสั่งให้ทำอะไรต่อไปและข้อความที่แสดงจะแสดงติดกันบรรทัดเดียวครับ
<hr>
<hr>
<hr>
<hr>
 ...
 * สั่ง Run โปรแกรมและบันทึกผลที่ได้จากการรันโปรแกรม
<hr>![](https://github.com/JUBJIBPIYAPATH/LAB-04/blob/master/LAB4.2.PNG?raw=true)
<hr>
<hr>
<hr>
<hr>
...
ผลที่ได้จากการทดลอง เป็นอย่างที่นักศึกษาคิดหรือไม่ อย่างไร  จงอธิบาย
<hr>เป็นอย่างคิดที่เมื่อแสดงข้อความเสร็จโปรแกรมก็จะบอกให้กดสักkeyพอกดแล้วก็จะปิดหน้านั้นไปเพราะรับkeyไม่มีทำสั่งให้ทำอะไรต่อไปและข้อความที่แสดงจะแสดงจะอยู่กันคนละบรรทัดครับ
<hr>
<hr>
<hr>
<hr>
...
<hr>Console.Write() แสดงข้อติดกันในบรรทัดเดียวกัน
<hr>Console.WriteLine() แสดงข้อความคนละบรรทัดไม่ติดกัน
<hr>
<hr>
<hr>
...
<hr> จากการทดลองสรุปได้ว่าถ้าเราต้องการแสดงข้อความในบรรทัดเดียวกันใช้คำสั่งConsole.Write("")และถ้าต้องการให้ข้อความแสดงคนละบรรทัดใช้คำสั่งConsole.WriteLine("")ครับ
<hr>
<hr>
<hr>
<hr>
